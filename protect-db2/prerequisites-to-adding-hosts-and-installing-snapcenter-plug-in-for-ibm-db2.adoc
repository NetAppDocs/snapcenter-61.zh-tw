...
summary: 在新增主機和安裝插件包之前，您必須完成所有要求。  Windows、Linux 和 AIX 環境支援適用於 IBM Db2 的SnapCenter插件。 
---
...
若要在 IBM Db2 的SnapCenter插件上執行補充命令，必須將其包含在 _allowed_commands.config_ 檔案中。

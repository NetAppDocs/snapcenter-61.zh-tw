...
NOTE: AppObjectId 是“Host\Plugin\UID”，其中 UID = <instance_name> 表示手動發現的 DB2 實例資源，UID = <instance_name>\<databse_name> 表示 IBM Db2 資料庫資源。您可以從 Get-smResources cmdlet 取得 ResourceID。
